...
const serviceCatalog = {
  categories: [
    { id: 'money', name: 'Money Transfer & Payments', icon: FaWallet, color: '#6366F1' },
    { id: 'banks', name: 'Popular Credit Card Banks', icon: FaUniversity, color: '#4F46E5' },
    { id: 'loans', name: 'Loans', icon: FaHandHoldingUsd, color: '#F97316' },
    { id: 'insurance', name: 'Insurance', icon: FaShieldAlt, color: '#10B981' },
    { id: 'invest', name: 'Accounts & Investments', icon: FaChartPie, color: '#2563EB' },
    { id: 'other', name: 'Other Services', icon: FaEllipsisH, color: '#EC4899' },
    { id: 'travel', name: 'Travel & Bookings', icon: FaPlane, color: '#06B6D4' },
  ],
  services: [
    // Money Transfer & Payments
    { id: 'recharge', category: 'money', label: 'Recharge', icon: FaMobileAlt, color: '#6366F1', route: '/cms/recharge' },
    { id: 'money-transfer', category: 'money', label: 'To Mobile', icon: FaExchangeAlt, color: '#10B981', route: '/cms/money-transfer' },
    ...
    { id: 'fastag', category: 'money', label: 'Fastag Recharge', icon: FaTag, color: '#22C55E', route: '/cms/fastag' },
    { id: 'dth', category: 'money', label: 'DTH Recharge', icon: FaTv, color: '#2563EB', route: '/cms/recharge' },
    { id: 'water', category: 'money', label: 'Water Bills', icon: FaTint, color: '#3B82F6', route: '/cms/coming-soon' },
    ...
    { id: 'hdfc', category: 'banks', label: 'HDFC Bank', icon: FaUniversity, color: '#004C8F', route: '/credit-cards/hdfc' },
    { id: 'sbi', category: 'banks', label: 'SBI Card', icon: FaUniversity, color: '#22409A', route: '/credit-cards/sbi' },
    { id: 'axis', category: 'banks', label: 'Axis Bank', icon: FaUniversity, color: '#97144D', route: '/credit-cards/axis' },
    { id: 'yes', category: 'banks', label: 'Yes Bank', icon: FaUniversity, color: '#0066B3', route: '/credit-cards/yes-bank' },
    { id: 'icici', category: 'banks', label: 'ICICI Bank', icon: FaUniversity, color: '#B02A30', route: '/credit-cards/icici' },
    { id: 'kotak', category: 'banks', label: 'Kotak Bank', icon: FaUniversity, color: '#ED232A', route: '/credit-cards/kotak' },

    // Loans
    { id: 'personal-loan', category: 'loans', label: 'Personal Loan', icon: FaUser, color: '#16A34A', route: '/loans' },
    { id: 'home-loan', category: 'loans', label: 'Home Loan', icon: FaHome, color: '#6366F1', route: '/loans' },
    { id: 'business-loan', category: 'loans', label: 'Business Loan', icon: FaBriefcase, color: '#8B5CF6', route: '/loans' },
    ...
    // Insurance
    { id: 'term-ins', category: 'insurance', label: 'Term Insurance', icon: FaClock, color: '#6366F1', route: '/insurance' },
    ...
    { id: 'accident-ins', category: 'insurance', label: 'Personal Accident', icon: FaExclamationTriangle, color: '#9333EA', route: '/insurance' },

    // Accounts & Investments
    { id: 'savings', category: 'invest', label: 'Savings Account', icon: FaPiggyBank, color: '#16A34A', route: '/cms/coming-soon' },
    { id: 'current', category: 'invest', label: 'Current Account', icon: FaBuilding, color: '#F97316', route: '/cms/coming-soon' },
    { id: 'demat', category: 'invest', label: 'Demat Account', icon: FaChartBar, color: '#8B5CF6', route: '/cms/coming-soon' },
    ...
    // Other Services
    { id: 'upi-cc', category: 'other', label: 'UPI Credit Card', icon: FaQrcode, color: '#6366F1', route: '/cms/coming-soon' },
    { id: 'loan-cc', category: 'other', label: 'Loan on Credit Card', icon: FaHandHoldingUsd, color: '#8B5CF6', route: '/cms/coming-soon' },
    { id: 'fd-backed', category: 'other', label: 'FD Backed Card', icon: FaCreditCard, color: '#7C3AED', route: '/cms/coming-soon' },
    { id: 'credit-score', category: 'other', label: 'CIBIL Score', icon: FaChartBar, color: '#0EA5E9', route: '/cms/coming-soon' },
    { id: 'offers', category: 'other', label: 'Offers & Rewards', icon: FaGift, color: '#EC4899', route: '/cms/coming-soon' },
    { id: 'refer-earn', category: 'other', label: 'Refer & Earn', icon: FaGift, color: '#A855F7', route: '/cms/coming-soon' },
    ...
    { id: 'hotel', category: 'travel', label: 'Hotel Booking', icon: FaHotel, color: '#8B5CF6', route: '/cms/coming-soon' },
  ]
};
  ...
  return (
    <motion.button
      ...
      onMouseEnter={(e) => {
        ...
        e.currentTarget.style.boxShadow = `0 4px 16px ${service.color}18`;
      }}
      onMouseLeave={(e) => {
    ...
    <div style={{
      ...
      <div style={{
        ...
        <div>
          ...
          <p style={{
            fontSize: '13px', color: C.textLight, margin: '4px 0 0',
            fontWeight: 500,
