...
const appCtrl = require('../../controllers/admin/application.controller.js');
const { authenticate, syncUser, authorize, requireApprovedPartner } = require('../../middleware/auth.middleware.js');
const { upload } = require('../../services/partner/s3.service.js');
const { applicationRules, validate } = require('../../middleware/validation.middleware.js');
