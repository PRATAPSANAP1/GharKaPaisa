    ...
    return res.json({
      ...
      data: {
        customer: {
          ...
          dob: tokenData.dob,
          pan_number: tokenData.pan_number ? `${tokenData.pan_number.slice(0, 5)}****${tokenData.pan_number.slice(-1)}` : null,
          aadhaar_last4: tokenData.aadhaar_last4 ? `XXXX-XXXX-${tokenData.aadhaar_last4}` : null,
          city: tokenData.city,
