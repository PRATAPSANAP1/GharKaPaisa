...
router.post('/kyc/upload-pan', requirePartner, upload.any(), partnerCtrl.uploadPan);
router.post('/kyc/upload-cheque', requirePartner, upload.any(), partnerCtrl.uploadCheque);
