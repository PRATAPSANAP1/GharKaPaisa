...
router.get('/', jwtAuth, roleCheck('PARTNER', 'ADMIN', 'SUPER_ADMIN', 'EMPLOYEE'), ctrl.listLeads);
...
router.patch('/:id/status', jwtAuth, roleCheck('ADMIN', 'SUPER_ADMIN', 'EMPLOYEE'), ctrl.updateLeadStatus);
