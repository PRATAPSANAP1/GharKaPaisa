  ...
  try {
    ...
    const dataQuery = `
      SELECT l.*, 
        ...
        COALESCE(c.pan_number, l.pan_number) as customer_pan, 
        COALESCE(c.aadhaar_last4, l.aadhaar_last4) as customer_aadhaar,
        COALESCE(c.state, l.state) as customer_state, 
        COALESCE(c.pincode, l.pincode) as customer_pincode, 
        COALESCE(c.employment_type, l.employment_type) as customer_employment_type,
        COALESCE(c.monthly_income, l.monthly_income) as customer_monthly_income, 
